...
try {
  $fileUrl = "file:///" + ((Get-Item "c:\Users\nonst\recover\obsidian folder\006_AI_Workspace\habit-app\tests\test_task_deep_merge_and_persistence.html").FullName.Replace('\', '/'))
  ...
  Write-Host "=================================================="
  Write-Host " Gendrive Task Deep-Merge & Zero-Loss Engine Test Suite"
  Write-Host "=================================================="
