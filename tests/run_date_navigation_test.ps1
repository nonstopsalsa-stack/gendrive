...
try {
  $fileUrl = "file:///" + ((Get-Item "c:\Users\nonst\recover\obsidian folder\006_AI_Workspace\habit-app\tests\test_date_navigation_and_holidays.html").FullName.Replace('\', '/'))
  ...
  Write-Host "=================================================="
  Write-Host " Gendrive Japanese Holiday & Date Navigation Test Suite"
  Write-Host "=================================================="
