...
try {
  $fileUrl = "file:///" + ((Get-Item "c:\Users\nonst\recover\obsidian folder\006_AI_Workspace\habit-app\tests\test_preset_20_shortcuts.html").FullName.Replace('\', '/'))
  ...
  Write-Host "=================================================="
  Write-Host " Gendrive 20 Presets & Shortcuts Test Suite"
  Write-Host "=================================================="
